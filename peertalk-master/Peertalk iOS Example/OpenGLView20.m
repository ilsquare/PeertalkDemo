...
//    [EAGLContext setCurrentContext:_glContext];
//    glBindTexture(GL_TEXTURE_2D, _textureYUV[TEXY]);
//    glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, w, h, GL_RED_EXT, GL_UNSIGNED_BYTE, data->data[0]);
//    
//    //[self debugGlError];
//    
//    glBindTexture(GL_TEXTURE_2D, _textureYUV[TEXU]);
//    glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, w/2, h/2, GL_RED_EXT, GL_UNSIGNED_BYTE, data->data[1]);
//    
//    // [self debugGlError];
//    
//    glBindTexture(GL_TEXTURE_2D, _textureYUV[TEXV]);
//    glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, w/2, h/2, GL_RED_EXT, GL_UNSIGNED_BYTE, data->data[2]);
//    
//    //[self debugGlError];
//    
//    [self render];
